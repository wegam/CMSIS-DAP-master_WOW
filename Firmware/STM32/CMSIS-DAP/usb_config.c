...
#define USBD_HS_ENABLE              1		//20170215
...
#define USBD_STRDESC_SER            L"0001A0000005"
...
#define USBD_HID_EP_INTIN           2			//HID端点号
...
#define USBD_CDC_ACM_EP_INTIN           4				//CDC端点号
...
#define USBD_MULTI_IF              (USBD_CDC_ACM_ENABLE*(USBD_HID_ENABLE|USBD_MSC_ENABLE|USBD_ADC_ENABLE))		//USB复合设备一般用Interface Association Descriptor（IAD）实现，就是在要合并的接口前加上IAD描述符。
