 ...
 *------------------------------------------------------------------------------
 * Name:    USBD_User_HID_Mouse_%Instance%.c
 ...
 *
 * USBD_User_HID_Mouse_%Instance%.c implements the application specific 
 * functionality of the HID class and is used to receive and send data reports
 * to the USB Host.
 *
 * The implementation must match the configuration file USBD_Config_HID_%Instance%.h.
 * The following values in USBD_Config_HID_%Instance%.h affect the user code:
 *
 ...
 *    (for example for mouse this value has to be set to 52)
 *
 */
 
 
//! [code_USBD_User_HID_Mouse]
