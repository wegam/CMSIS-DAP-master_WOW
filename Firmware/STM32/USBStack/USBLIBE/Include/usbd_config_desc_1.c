...
__weak \
const uint8_t usbd1_ep0_descriptor[] = { USBD_EP0(1) };

/* USB Device 1 Standard Descriptor */
__weak \
const uint8_t usbd1_device_descriptor[] = {
...
__weak \
const uint8_t usbd1_config_descriptor_fs[] = {
  /* Configuration 1 */
...
__weak \
const uint8_t usbd1_device_qualifier_fs[]              = { 0 };
__weak \
const uint8_t usbd1_device_qualifier_hs[]              = { 0 };
__weak \
const uint8_t usbd1_config_descriptor_hs[]             = { 0 };
__weak \
const uint8_t usbd1_other_speed_config_descriptor_fs[] = { 0 };
__weak \
const uint8_t usbd1_other_speed_config_descriptor_hs[] = { 0 };
...
__weak \
const uint8_t usbd1_device_qualifier_fs[] = {
...
__weak \
const uint8_t usbd1_device_qualifier_hs[] = {
  USB_DEVICE_QUALI_SIZE,                /* bLength */
  USB_DEVICE_QUALIFIER_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(0x0200), /* 2.00 */             /* bcdUSB */
  0x00,                                 /* bDeviceClass */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd1_config_descriptor_hs[] = {
  /* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
  USB_CONFIGURATION_DESCRIPTOR_TYPE,    /* bDescriptorType */
  WBVAL(USBD1_WTOTALLENGTH),            /* wTotalLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd1_other_speed_config_descriptor_fs[] = {
  /* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd1_other_speed_config_descriptor_hs[] = {
/* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
  USB_OTHER_SPEED_CONFIG_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(USBD1_WTOTALLENGTH),            /* wTotalLength */
...
const struct {
  ...
  USBD_STR_DEF(USBD1_STR_DESC_MAN);
  USBD_STR_DEF(USBD1_STR_DESC_PROD);
#if  (USBD1_STR_DESC_SER_EN)
  USBD_STR_DEF(USBD1_STR_DESC_SER);
#endif
...
usbd_desc_t usbd1_desc = {
  (uint8_t *)usbd1_ep0_descriptor,
  (uint8_t *)usbd1_device_descriptor,
  (uint8_t *)usbd1_device_qualifier_fs,
  (uint8_t *)usbd1_device_qualifier_hs,
  (uint8_t *)usbd1_config_descriptor_fs,
  (uint8_t *)usbd1_config_descriptor_hs,
  (uint8_t *)usbd1_other_speed_config_descriptor_fs,
  (uint8_t *)usbd1_other_speed_config_descriptor_hs,
  (uint8_t *)&usbd1_string_descriptor
};
