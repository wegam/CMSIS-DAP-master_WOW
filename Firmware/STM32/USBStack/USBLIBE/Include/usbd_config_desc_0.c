...
__weak \
const uint8_t usbd0_ep0_descriptor[] = { USBD_EP0(0) };
...
__weak \
const uint8_t usbd0_config_descriptor_fs[] = {
  /* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
  USB_CONFIGURATION_DESCRIPTOR_TYPE,    /* bDescriptorType */
  WBVAL(USBD0_WTOTALLENGTH),            /* wTotalLength */
  USBD0_IF_CNT,                         /* bNumInterfaces */
  0x01,                                 /* bConfigurationValue: 0x01 is used to select this configuration */
  0x00,                                 /* iConfiguration: no string to describe this configuration */
  USBD0_CFG_DESC_BMATTRIBUTES,          /* bmAttributes */
  USBD0_CFG_DESC_BMAXPOWER,             /* bMaxPower, device power consumption */

#if (USBD0_CUSTOM_CLASS0)
#if (USBD0_USE_IAD)
...
__weak \
const uint8_t usbd0_device_qualifier_fs[]              = { 0 };
__weak \
const uint8_t usbd0_device_qualifier_hs[]              = { 0 };
__weak \
const uint8_t usbd0_config_descriptor_hs[]             = { 0 };
__weak \
const uint8_t usbd0_other_speed_config_descriptor_fs[] = { 0 };
__weak \
const uint8_t usbd0_other_speed_config_descriptor_hs[] = { 0 };

#else

#if (USBD0_ADC0 || USBD0_ADC1 || USBD0_ADC2 || USBD0_ADC3)
#error High-speed is not supported for Audio Device!
#endif

/* USB Device 0 Qualifier Descriptor (in Full Speed for High Speed) */
__weak \
const uint8_t usbd0_device_qualifier_fs[] = {
...
__weak \
const uint8_t usbd0_device_qualifier_hs[] = {
  USB_DEVICE_QUALI_SIZE,                /* bLength */
  USB_DEVICE_QUALIFIER_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(0x0200), /* 2.00 */             /* bcdUSB */
  0x00,                                 /* bDeviceClass */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd0_config_descriptor_hs[] = {
  /* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
  USB_CONFIGURATION_DESCRIPTOR_TYPE,    /* bDescriptorType */
  WBVAL(USBD0_WTOTALLENGTH),            /* wTotalLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd0_other_speed_config_descriptor_fs[] = {
  /* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor) */
__weak \
const uint8_t usbd0_other_speed_config_descriptor_hs[] = {
/* Configuration 1 */
  USB_CONFIGURATION_DESC_SIZE,          /* bLength */
  USB_OTHER_SPEED_CONFIG_DESCRIPTOR_TYPE, /* bDescriptorType */
  WBVAL(USBD0_WTOTALLENGTH),            /* wTotalLength */
...
const struct {
  ...
  USBD_STR_DEF(USBD0_STR_DESC_MAN);
  USBD_STR_DEF(USBD0_STR_DESC_PROD);
#if  (USBD0_STR_DESC_SER_EN)
  USBD_STR_DEF(USBD0_STR_DESC_SER);
#endif
  ...
  =
{
  { 4, USB_STRING_DESCRIPTOR_TYPE, USBD0_STR_DESC_LANGID },
  USBD_STR_VAL(USBD0_STR_DESC_MAN),
  USBD_STR_VAL(USBD0_STR_DESC_PROD),
#if (USBD0_STR_DESC_SER_EN)
  USBD_STR_VAL(USBD0_STR_DESC_SER),
#endif
...
usbd_desc_t usbd0_desc = {
  (uint8_t *)usbd0_ep0_descriptor,
  (uint8_t *)usbd0_device_descriptor,
  (uint8_t *)usbd0_device_qualifier_fs,
  (uint8_t *)usbd0_device_qualifier_hs,
  (uint8_t *)usbd0_config_descriptor_fs,
  (uint8_t *)usbd0_config_descriptor_hs,
  (uint8_t *)usbd0_other_speed_config_descriptor_fs,
  (uint8_t *)usbd0_other_speed_config_descriptor_hs,
  (uint8_t *)&usbd0_string_descriptor
};
