 ...
 * ---------------------               -----
 * Assign Device Class to USB Device # = %Instance%
 *----------------------------------------------------------------------------*/

//-------- <<< Use Configuration Wizard in Context Menu >>> --------------------

// <h>USB Device %Instance%
...
#define USBD%Instance%_MAX_PACKET0               8

//     <o.0..15>Vendor ID <0x0000-0xFFFF>
//     <i>Vendor ID assigned by USB-IF (idVendor).
#define USBD%Instance%_DEV_DESC_IDVENDOR         0xC251
...
#define USBD%Instance%_CFG_DESC_BMATTRIBUTES     0x80
...
#define USBD%Instance%_CFG_DESC_BMAXPOWER        250
