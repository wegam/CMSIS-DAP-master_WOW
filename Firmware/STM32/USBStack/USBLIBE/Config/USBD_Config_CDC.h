...
#define USBD_CDC%Instance%_ACM_SEND_BUF_SIZE      1024
...
//         <8=>    8 Bytes <16=>  16 Bytes <32=>  32 Bytes <64=>    64 Bytes
//         <128=>128 Bytes <256=>256 Bytes <512=>512 Bytes <1024=>1024 Bytes
#define USBD_CDC%Instance%_ACM_RECEIVE_BUF_SIZE   1024
...
#define USBD_CDC%Instance%_NCM_MAC_ADDRESS        L"1E306CA2455E"
...
//       </h>
#define USBD_CDC%Instance%_NCM_BM_ETHERNET_STATISTICS     0x00000003
...
#define USBD_CDC%Instance%_NCM_W_MAX_SEGMENT_SIZE         1514
...
#define USBD_CDC%Instance%_NCM_W_NUMBER_MC_FILTERS        1
...
#define USBD_CDC%Instance%_NCM_B_NUMBER_POWER_FILTERS     0
...
//       </h>
#define USBD_CDC%Instance%_NCM_BM_NETWORK_CAPABILITIES    0x1B
...
//           <o.1>32-bit NTB
//         </h>
#define USBD_CDC%Instance%_NCM_BM_NTB_FORMATS_SUPPORTED   0x0001

//         <h>IN Data Pipe
//
//           <o>Maximum NTB Size (dwNtbInMaxSize)
//           <i>Specifies maximum IN NTB size in bytes.
#define USBD_CDC%Instance%_NCM_DW_NTB_IN_MAX_SIZE         4096
...
#define USBD_CDC%Instance%_NCM_W_NDP_IN_DIVISOR           4
...
#define USBD_CDC%Instance%_NCM_W_NDP_IN_PAYLOAD_REMINDER  0
...
#define USBD_CDC%Instance%_NCM_W_NDP_IN_ALIGNMENT         4
...
#define USBD_CDC%Instance%_NCM_DW_NTB_OUT_MAX_SIZE        4096
...
#define USBD_CDC%Instance%_NCM_W_NDP_OUT_DIVISOR          4
...
#define USBD_CDC%Instance%_NCM_W_NDP_OUT_PAYLOAD_REMINDER 0

//           <o.0..15>NDP Alignment Modulus in NTB (wNdpOutAlignment)
//           <i>Specifies NDP alignment modulus for NTBs on the IN pipe.
//           <i>Shall be power of 2, and shall be at least 4.
#define USBD_CDC%Instance%_NCM_W_NDP_OUT_ALIGNMENT        4
...
#define USBD_CDC%Instance%_NCM_RAW_ENABLE         0
