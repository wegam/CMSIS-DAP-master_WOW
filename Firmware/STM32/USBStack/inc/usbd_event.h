 ...
 *------------------------------------------------------------------------------
 *      Name:    usbd_event.h
 *      Purpose: USB Device Event header file
 *      Rev.:    V4.70
 *------------------------------------------------------------------------------
...
#define USBD_EVT_SETUP       (1 <<  1)  /* Setup Packet                       */	//setup包
#define USBD_EVT_OUT         (1 <<  2)  /* OUT Packet                         */	//输出包事件
#define USBD_EVT_IN          (1 <<  3)  /*  IN Packet                         */	//输入包
#define USBD_EVT_OUT_NAK     (1 <<  4)  /* OUT Packet - Not Acknowledged      */
#define USBD_EVT_IN_NAK      (1 <<  5)  /*  IN Packet - Not Acknowledged      */
#define USBD_EVT_OUT_STALL   (1 <<  6)  /* OUT Packet - Stalled               */	//输出延迟/等待
#define USBD_EVT_IN_STALL    (1 <<  7)  /*  IN Packet - Stalled               */	//输入延迟/等待
...
extern void (* const USBD_P_Reset_Event    )(void);					//复位串口为默认状态9600
